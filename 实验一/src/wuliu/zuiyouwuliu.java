...
public static void main(String[] args) {
	...
	ob[4]=new object("手表",20200607090100L,"成都","西安",3,false);
	...
	//		System.out.printf("从"+obj.gets()+"到"+obj.getdes()+"理论时间为");
	//		x.print.add("从"+obj.gets()+"到"+obj.getdes()+"理论时间为");
